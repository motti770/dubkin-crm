    ...
    <div className="flex flex-col min-h-screen pb-24">
      ...
      <section className="px-6 mb-6">
        <div className="grid grid-cols-2 gap-4">
          {/* Pipeline Total */}
          <div className="glass-panel-dark rounded-3xl p-5 shadow-glass col-span-2 relative overflow-hidden">
      ...
      <section className="px-6 flex-1">
        <div className="glass-panel rounded-3xl p-5 shadow-glass">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-4">
              {stats.stageStats.map(({ stage, count, total, percent }) => {
        ...
        {/* Summary footer */}
        <div className="mt-4 glass-panel rounded-3xl p-4 shadow-glass">
