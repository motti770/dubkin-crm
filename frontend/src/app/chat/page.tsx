...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-24 md:pb-8 page-enter">
      ...
      <div className="md:grid md:grid-cols-2 md:gap-6 px-2 md:px-0">
        {/* Partner Cards */}
        <section className="mb-6 md:mb-0">
          ...
          <div className="flex flex-col gap-4">
            {PARTNERS.map((partner, i) => (
              <div
                key={partner.name}
                className="glass-panel rounded-3xl p-5 shadow-glass hover:shadow-lg transition-all duration-200 fade-in-up"
              ...
              >
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="flex-1 bg-[#25D366] text-white rounded-2xl py-3 flex items-center justify-center gap-2 text-sm font-semibold hover:bg-[#20b458] transition-all duration-200 shadow-lg active:scale-95"
                  >
                  ...
                  <a
                    ...
                    className="glass-panel rounded-2xl py-3 px-4 flex items-center justify-center gap-2 text-sm font-semibold text-blue-600 hover:bg-white/80 transition-all duration-200 active:scale-95"
                  >
              ...
              {notes.map((activity, i) => (
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-amber-50 flex items-center justify-center shrink-0 text-amber-600">
                    <span className="material-symbols-outlined text-[18px]">{getTypeIcon(activity.type)}</span>
                  </div>
                  <div className="flex-1 min-w-0">
